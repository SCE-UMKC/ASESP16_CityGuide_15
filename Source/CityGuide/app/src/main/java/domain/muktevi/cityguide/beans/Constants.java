...
/**
 * Created by Muktevi on 2/19/2016.
 */
public class Constants {

    public static final String SERIAL_KEY= "domain.muktevi.cityguide.serial";
    public static final String CLIENT_ID = "P2IIU4YKUJ2ILBZMYLTDO42TUKACIOTJ5QVEYUK3F2ZAW0K3";
